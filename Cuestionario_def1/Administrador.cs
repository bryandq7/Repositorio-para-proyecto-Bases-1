...
namespace Cuestionario_def1
{
    class Administrador
    {
        ...
        //public int id_tipo_cajero { get; set; }
        ...
        //public Administrador(int pCedula, string pNombre1, string pNombre2, string pApellido1,
        ...
        //    int pid_tipo_telefono, int pid_tipo_correo, int pid_tipo_cajero,
        //    int pid_tipo_usuario, int pactivo, string pFecha_Ing, int pSalario)
        ...
        //{
            ...
            //this.id_tipo_cajero = pid_tipo_cajero;
            //this.activo = pactivo;
